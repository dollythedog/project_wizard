...
class CharterAgent:
    ...
    def _load_prompts(self) -> Dict:
        ...
        try:
            config_path = Path(__file__).parent.parent.parent / "configs" / "enhancement_prompts.json"
    ...
    def enhance_section(self, section_key: str, user_text: str, feedback: Optional[str] = None) -> str:
        """
...
{chunk}"""
    ...
    def draft_schedule_overview(self, project_brief: str, duration_days: int = None, context: Dict = None) -> str:
        """Legacy method - kept for compatibility."""
        return self._generic_enhance(project_brief)
