...
class CharterData(BaseModel):
    ...
    project_type: str | None = Field(
        default=None, description="software_mvp, clinical_workflow, etc."
    )
    estimated_budget: float | None = Field(default=None, description="Total estimated cost")
    estimated_duration_days: int | None = Field(default=None, description="Project length in days")
